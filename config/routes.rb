...
Rails.application.routes.draw do
  ...
  add_swagger_route 'DELETE', '/api/v1/comments', controller_name: 'comments', action_name: 'delete_comment'
  add_swagger_route 'PATCH', '/api/v1/comments', controller_name: 'comments', action_name: 'update_comment'
  add_swagger_route 'POST', '/api/v1/corrections', controller_name: 'corrections', action_name: 'create'
  add_swagger_route 'DELETE', '/api/v1/corrections', controller_name: 'corrections', action_name: 'delete_correction'
  add_swagger_route 'PATCH', '/api/v1/corrections', controller_name: 'corrections', action_name: 'update_correction'
  ...
  add_swagger_route 'GET', '/api/v1/portfolios/{page}/position/{position}/status/{status}', controller_name: 'portfolios', action_name: 'show'
  add_swagger_route 'PATCH', '/api/v1/portfolios/{uuid}', controller_name: 'portfolios', action_name: 'update'
  add_swagger_route 'POST', '/api/v1/sessions', controller_name: 'sessions', action_name: 'create'
  add_swagger_route 'DELETE', '/api/v1/sessions/{uuid}', controller_name: 'sessions', action_name: 'destroy'
